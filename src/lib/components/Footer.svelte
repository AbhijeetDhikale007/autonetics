  ...
  <div class="container mx-auto px-6 pt-16 pb-8">
    <div class="grid grid-cols-1 md:grid-cols-3 md:gap-8 lg:gap-12 mb-16">
      ...
      <div class="flex flex-col gap-5">
        ...
        >
          Autonetics Training Center provides PLC training, SCADA training,
          Automation training, and Electrical design courses in Nashik. We
          specialize in cutting-edge robotics and advanced system integrations.
        </p>
        ...
        <div class="flex flex-wrap gap-3 pt-2">
          <a
            ...
            target="_blank"
            aria-label="LinkedIn"
            class="grid place-items-center w-10 h-10 rounded-full text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all"
          >
            <Ico name="LinkedIn" />
          </a>
          <a
    ...
    >
      ...
      <p class="text-sm text-slate-500 dark:text-slate-400">
        Designed by <a
          href="https://abhijeetdhikale007.vercel.app/"
          target="_blank"
          class="font-Roboto select-none text-blue-600 dark:text-blue-400 font-medium"
          >Λʙʜιנєєτ Ðʜικαℓє</a
        >.
      </p>
    </div>
